...
public class IndexModel : PageModel
{
	...
	public class InputModel
	{
		...
		[Display(Name = "Int as text")]
		public int IntAsText { get; set; } = 23;

		[HiddenInput] public string HiddenInput { get; set; } = "Some text";

		[DataType(DataType.Password)] public string Password { get; set; } = "Some text";

		[Phone] public string Phone { get; set; } = "12345678";

		[EmailAddress] public string Email { get; set; } = "test@example.com";

		[Url] public string Url { get; set; } = "https://andrewlock.net";

		[DataType(DataType.Date)]
		[Display(Name = "String as date")]
