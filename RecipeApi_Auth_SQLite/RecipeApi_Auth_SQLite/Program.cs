...
// I place these after UseSwagger so that you can open Swagger UI without being authenticated
...
routes.MapGet("/", async (RecipeService service) => { return await service.GetRecipes(); })
...
public class EditRecipeBase
{
	...
	[DisplayName("Vegetarian?")] public bool IsVegetarian { get; set; }

	[DisplayName("Vegan?")] public bool IsVegan { get; set; }
}
...
public class CreateIngredientCommand
{
	...
	[Required] [StringLength(20)] public required string Unit { get; set; }
